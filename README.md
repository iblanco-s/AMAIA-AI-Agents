...
- `bonus-human-in-the-loop-es`: Interacción humana en el flujo del agente
- `bonus-mcp-remote-server-es`: Servidor MCP remoto
- `bonus-structured-outputs-es`: Salidas estructuradas
